	             	...
	             	<div class="col-lg-11 col-xl-9 col-xxl-8">
	                       ...
	                       <div class="input-group mb-3">
							...
							<div class="input-group mb-3">
							  ...
							  <input type="text" class="form-control" name="name" placeholder="홍길동" aria-label="Name" aria-describedby="basic-addon3">
							</div>
							
							<div class="input-group mb-3">
							  <span class="input-group-text" id="basic-addon4">Email</span>
							  <input type="email" class="form-control" name="email" placeholder="Gildong@example.com" aria-label="Email" aria-describedby="basic-addon4">
							</div>
							
							<div class="input-group mb-3">
							  <span class="input-group-text" id="basic-addon5">PHONE</span>
							  <input type="text" class="form-control" name="phone" placeholder="010-0000-0000" aria-label="Phone" aria-describedby="basic-addon5">
							</div>
